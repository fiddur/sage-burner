...
- **The rewrite box under ✏️ carries the time of the meeting it belongs to**, so a diary with two
  meetings of one name offers two different controls rather than two identical ones.
