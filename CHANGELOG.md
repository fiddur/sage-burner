...
- **A summary by email when you have been away.** If something happens and you have not been on the
  ...
  have read everything is a day it stays quiet. It covers everything since you were last on the
  site, so somebody who signed up and has not been back hears about the dreams and the meeting
  points they have missed, not just the last day of them. It is on unless you say otherwise — Your
  details → Notifications has _Every day_, _Every week_ and _Never_ — and it needs a mail server,
  so an installation without one is unchanged.
