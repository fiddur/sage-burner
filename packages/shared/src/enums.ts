...
export const notificationCategoryInfo = {
  meal_role: { label: 'Put on or taken off a meal', on: true, email: false, about: 'you' },
  dream_role: { label: 'Put on or taken off a dream', on: true, email: false, about: 'you' },
  lead_role: { label: 'Given or taken off a lead role', on: true, email: false, about: 'you' },
  payment: { label: 'Your payment recorded', on: true, email: false, about: 'you' },
  waiting_list_near: {
  ...
  dream_offered: { label: 'Somebody offers a dream', on: false, email: false, about: 'else' },
  dream_comment: {
    label: 'Somebody comments on a dream you are part of',
    on: true,
    email: false,
    about: 'you',
  },
  dream_comment_any: { label: 'Somebody comments on any dream', on: false, email: false, about: 'else' },
  member_joined: { label: 'Somebody says they are coming', on: false, email: false, about: 'else' },
  introduction_written: { label: 'Somebody says who they are', on: false, email: false, about: 'else' },
  introduction_comment: { label: 'Somebody comments on your own card', on: true, email: false, about: 'you' },
  introduction_comment_any: {
    label: 'Somebody comments on anybody’s card',
    on: false,
    email: false,
    about: 'else',
  },
  post_written: { label: 'Somebody announces something', on: false, email: false, about: 'else' },
  post_comment: {
    label: 'Somebody comments on something you announced',
    on: true,
    email: false,
    about: 'you',
  },
  post_comment_any: { label: 'Somebody comments on an announcement', on: false, email: false, about: 'else' },
  song_added: { label: 'A song goes into the songbook', on: false, email: false, about: 'else' },
  song_comment: { label: 'Somebody comments on a song you put in', on: true, email: false, about: 'you' },
  song_comment_any: { label: 'Somebody comments on any song', on: false, email: false, about: 'else' },
  bring_added: {
    label: 'Somebody wants or offers something to bring',
    on: false,
    email: false,
    about: 'else',
  },
  bring_answered: { label: 'Somebody brings what you asked for', on: true, email: false, about: 'you' },
  bring_role: { label: 'Put on or taken off bringing something', on: true, email: false, about: 'you' },
  bring_comment: {
  ...
  bring_comment_any: {
    label: 'Somebody comments on anything on the bring list',
    on: false,
    email: false,
    about: 'else',
  },
  ...
  point_comment_any: {
    label: 'Somebody comments on any talking point',
    on: false,
    email: false,
    about: 'else',
  },
  meeting_scheduled: { label: 'A meeting is put in the diary', on: true, email: false, about: 'else' },
  meeting_comment: {
    label: 'Somebody comments on a meeting you put in the diary',
    on: true,
    email: false,
    about: 'you',
  },
  meeting_comment_any: { label: 'Somebody comments on any meeting', on: false, email: false, about: 'else' },
  mentioned: { label: 'Somebody names you', on: true, email: false, about: 'you' },
  lead_role_added: { label: 'A lead role is added', on: false, email: false, about: 'else' },
  lead_role_filled: { label: 'Somebody takes the lead of a role', on: false, email: false, about: 'else' },
  lead_role_comment: {
    label: 'Somebody comments on a role you are on',
    on: true,
    email: false,
    about: 'you',
  },
  lead_role_comment_any: {
    label: 'Somebody comments on any lead role',
    on: false,
    email: false,
    about: 'else',
  },
  meal_taken: { label: 'Somebody takes on a meal or a chore', on: false, email: false, about: 'else' },
  meal_comment: { label: 'Somebody comments on a meal you are on', on: true, email: false, about: 'you' },
  meal_comment_any: { label: 'Somebody comments on any meal', on: false, email: false, about: 'else' },
