...
const clientWith = (
  ...
  getPantry: () => Promise.reject(new Error('getPantry is not stubbed in this file')),
  setPantryStock: () => Promise.reject(new Error('setPantryStock is not stubbed in this file')),
  addPantryItem: () => Promise.reject(new Error('addPantryItem is not stubbed in this file')),
  updatePantryItem: () => Promise.reject(new Error('updatePantryItem is not stubbed in this file')),
  withdrawPantryItem: () => Promise.reject(new Error('withdrawPantryItem is not stubbed in this file')),
  restorePantryItem: () => Promise.reject(new Error('restorePantryItem is not stubbed in this file')),
  getSpecialBuys: () => Promise.resolve({ buys: [] }),
  adoptSpecialBuy: () => Promise.reject(new Error('adoptSpecialBuy is not stubbed in this file')),
  getPantryPlaces: () => Promise.reject(new Error('getPantryPlaces is not stubbed in this file')),
  addPantryPlace: () => Promise.reject(new Error('addPantryPlace is not stubbed in this file')),
  updatePantryPlace: () => Promise.reject(new Error('updatePantryPlace is not stubbed in this file')),
  deletePantryPlace: () => Promise.reject(new Error('deletePantryPlace is not stubbed in this file')),
  reorderPantryPlaces: () => Promise.reject(new Error('reorderPantryPlaces is not stubbed in this file')),
  putPantrySpot: () => Promise.reject(new Error('putPantrySpot is not stubbed in this file')),
  removePantrySpot: () => Promise.reject(new Error('removePantrySpot is not stubbed in this file')),
  getEventPantry: () => Promise.reject(new Error('getEventPantry is not stubbed in this file')),
  heartPantryItem: () => Promise.reject(new Error('heartPantryItem is not stubbed in this file')),
  unheartPantryItem: () => Promise.reject(new Error('unheartPantryItem is not stubbed in this file')),
  markPantryBought: () => Promise.reject(new Error('markPantryBought is not stubbed in this file')),
  unmarkPantryBought: () => Promise.reject(new Error('unmarkPantryBought is not stubbed in this file')),
  flagPantryNeedMore: () => Promise.reject(new Error('flagPantryNeedMore is not stubbed in this file')),
  unflagPantryNeedMore: () => Promise.reject(new Error('unflagPantryNeedMore is not stubbed in this file')),
