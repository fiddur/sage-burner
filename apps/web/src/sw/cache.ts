...
export const planFor = (
  ...
  // Same argument for the changelog (#325), the privacy policy (#402) and the terms (#419):
  // prose on a page anybody can see, so there is nothing in any of them a sign-out should
  // take away.
